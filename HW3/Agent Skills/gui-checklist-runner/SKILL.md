...
description: >
  Executes GUI testing checklists for HW03 Task 1 using Playwright automation scripts against running SUT instances. Evaluates Pass/Fail for checklist items (IA-01..IA-04), captures evidence screenshots for Failed items in HW3/Task1_GUI/Evidences/, updates CHECKLIST.md and CHECKLIST.csv with execution results, and generates Bug Reports in HW3/Task1_GUI/Bug Report/ and GitHub Issues.
---
...
- Capture visual evidence screenshots for **Failed items** saved in `HW3/Task1_GUI/Evidences/`
- Update `HW3/Task1_GUI/CHECKLIST.md` and `HW3/Task1_GUI/CHECKLIST.csv` with execution status (`Pass`/`Fail`), actual results, notes (reasons for failure), and evidence links
- Generate detailed **Bug Reports** in `HW3/Task1_GUI/Bug Report/` and prepare GitHub Issue drafts (including attached screenshots) for all discovered bugs
...
3. **Input Checklist**:
   - `HW3/Task1_GUI/CHECKLIST.md` and `HW3/Task1_GUI/CHECKLIST.csv` (contains design items with empty status columns).
...
- Read `HW3/Task1_GUI/CHECKLIST.md` to collect all checklist item IDs and expected results.
...
5. Saves Evidence Screenshots for **Failed items only** to `HW3/Task1_GUI/Evidences/GUI-<ITEM-ID>.png`.
...
- `Bằng chứng` / `Evidence`: Markdown link to `Evidences/GUI-<ITEM-ID>.png` for Failed items

### Step 4: Generate Bug Reports & GitHub Issues

For every `Fail` item, create a Bug Report file `HW3/Task1_GUI/Bug Report/BUG-<MODULE>-<00N>.md` strictly following `bug-report-template.md` (English section headers + Vietnamese body content):
