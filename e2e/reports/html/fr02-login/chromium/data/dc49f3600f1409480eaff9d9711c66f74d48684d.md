...
- Name: fr02-login.spec.ts >> FR-02 Login & Account Lockout (12 cases) >> FR02-09: Email length 255 — over RFC 5321 max
- Location: tests/fr02-login.spec.ts:156:9

# Error details

```
Error: Expected format-related error, got: "Đăng nhập thất bại. Vui lòng kiểm tra lại."
