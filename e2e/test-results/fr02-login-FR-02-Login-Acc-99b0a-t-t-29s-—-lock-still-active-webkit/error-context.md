...
- Name: fr02-login.spec.ts >> FR-02 Login & Account Lockout (12 cases) >> FR02-04: Correct login at t=29s — lock still active
...
Call log:
  ...
  - waiting for locator('div.bg-red-100')
    24 × locator resolved to <div class="bg-red-100 text-red-700 p-3 mt-4 rounded">Đăng nhập thất bại. Vui lòng kiểm tra lại.</div>
