...
| [`doc_generator`](./doc_generator/SKILL.md)                     | Hỗ trợ tạo báo cáo, đề xuất, đặc tả và tài liệu có cấu trúc.                                     | Khi yêu cầu tạo hoặc cập nhật tài liệu với các đầu ra do skill quy định.                         |
| [`md-to-pdf`](./md-to-pdf/SKILL.md)                             | Hướng dẫn xuất Markdown thành PDF có định dạng nhất quán.                                        | Khi người dùng yêu cầu xuất Markdown sang PDF bằng cấu hình và stylesheet chuyên dụng.           |
