...
| ------------------------- | ----------------------------------------------------- | ----------------- | -------------------------------------------------- | -------- |
| FR-04 / Domain Partition  | `FR04-USRME-DP-001` đến `FR04-USRME-DP-022`           | 0 Pass / 22 Fail  | BUG-USRME-001, 003, 004, 005                       | Executed |
| FR-04 / State Transition  | `FR04-USRME-ST-001` đến `FR04-USRME-ST-008`           | 0 Pass / 8 Fail   | BUG-USRME-001, 003                                 | Executed |
| FR-04 / Security          | `FR04-USRME-SEC-001` đến `FR04-USRME-SEC-016`         | 0 Pass / 16 Fail  | BUG-USRME-001, 002, 003                            | Executed |
...
| FR-17 / Security          | `FR17-ADMINCOUP-SEC-001` đến `FR17-ADMINCOUP-SEC-009` | 1 Pass / 8 Fail   | BUG-ADMINCOUPON-001, 002, 004, 005                 | Executed |
| FR-17 / Schema Validation | `FR17-ADMINCOUP-SC-001` đến `FR17-ADMINCOUP-SC-006`   | 1 Pass / 5 Fail   | BUG-ADMINCOUPON-001, 002, 003, 004                 | Executed |
