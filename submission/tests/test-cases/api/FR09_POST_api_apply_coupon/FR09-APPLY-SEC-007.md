# FR09-APPLY-SEC-007: Mass assignment field ngoài spec
...
- Token user thường hợp lệ; request gửi thêm trường ngoài spec.
...
| SEC Ref  | SEC-02                                                                             |
| Priority | Medium                                                                             |
| Input    | `{"code":"SAVE10","total_amount":500000,"user_id":1,"role":"admin","is_active":1}` |
...
Hệ thống bỏ qua hoặc từ chối field ngoài spec; quyền user và trạng thái coupon không bị thay đổi.
