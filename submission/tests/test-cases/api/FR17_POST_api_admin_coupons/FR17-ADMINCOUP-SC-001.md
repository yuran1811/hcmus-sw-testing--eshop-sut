...
Theo execution contract A-FR17: HTTP 201; response khớp schema coupon_created_exact; CSDL có đúng một coupon khớp sáu trường cho phép, mặc định active, không thay đổi user hoặc coupon seed khác.
