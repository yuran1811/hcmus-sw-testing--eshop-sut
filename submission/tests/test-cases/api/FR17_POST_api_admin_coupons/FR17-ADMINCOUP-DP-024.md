# FR17-ADMINCOUP-DP-024: max_uses_per_user âm
...
| SEC Ref  | N/A                                                                                                                             |
| Priority | High                                                                                                                            |
| Input    | `{"code":"USENEG","type":"fixed","discount_value":10000,"min_order_amount":0,"expired_at":"2099-01-31","max_uses_per_user":-1}` |
...
Hệ thống không tạo coupon với `max_uses_per_user` âm vì field này phải `>= 1`. Ghi nhận mã trạng thái thực tế.
