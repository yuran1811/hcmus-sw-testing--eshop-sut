# FR17-ADMINCOUP-DP-020: Thiếu expired_at
...
| SEC Ref  | N/A                                                                                                    |
| Priority | High                                                                                                   |
| Input    | `{"code":"DATEMISS","type":"fixed","discount_value":10000,"min_order_amount":0,"max_uses_per_user":1}` |
...
Hệ thống từ chối request vì thiếu `expired_at` bắt buộc và không tạo coupon. Ghi nhận mã trạng thái thực tế.
