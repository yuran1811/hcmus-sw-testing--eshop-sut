# FR17-ADMINCOUP-DP-012: discount_value bằng 0
...
| SEC Ref  | N/A                                                                                                                                 |
| Priority | High                                                                                                                                |
| Input    | `{"code":"ZERODISC","type":"percent","discount_value":0,"min_order_amount":200000,"expired_at":"2099-01-31","max_uses_per_user":1}` |
...
Hệ thống không tạo coupon với `discount_value = 0` vì field này phải dương. Ghi nhận mã trạng thái thực tế.
