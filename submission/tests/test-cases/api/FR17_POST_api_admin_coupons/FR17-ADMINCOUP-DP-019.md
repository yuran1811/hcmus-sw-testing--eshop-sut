# FR17-ADMINCOUP-DP-019: Thiếu min_order_amount
...
| SEC Ref  | N/A                                                                                                        |
| Priority | High                                                                                                       |
| Input    | `{"code":"MINMISS","type":"fixed","discount_value":10000,"expired_at":"2099-01-31","max_uses_per_user":1}` |
...
Hệ thống từ chối request vì thiếu `min_order_amount` bắt buộc và không tạo coupon. Ghi nhận mã trạng thái thực tế.
