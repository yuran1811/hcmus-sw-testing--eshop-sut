# FR17-ADMINCOUP-DP-009: Thiếu type
...
| SEC Ref  | N/A                                                                                                                 |
| Priority | High                                                                                                                |
| Input    | `{"code":"TYPEMISS","discount_value":15,"min_order_amount":200000,"expired_at":"2099-01-31","max_uses_per_user":1}` |
...
Hệ thống từ chối request vì thiếu `type` bắt buộc và không tạo coupon. Ghi nhận mã trạng thái thực tế.
