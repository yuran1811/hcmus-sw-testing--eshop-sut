# FR04-USRME-DP-022: Sai Content-Type
...
| SEC Ref  | N/A                                           |
| Priority | Medium                                        |
| Input    | `Content-Type: text/plain; body: name=Nguyen` |
...
Theo execution contract A-FR04: HTTP 415; response khớp schema error_required; hồ sơ, role, email, password/reset token và user khác không thay đổi.
