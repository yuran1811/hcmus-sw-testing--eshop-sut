...
| Identify and reset account state between runs                                 | Re-seed before each official run + documented SQL reset command | `test-summary.md` sections 4.1-4.3 + `submission/tests/1-test-plans/checkout-with-coupon/README.md` reset section   | `Pass`           | `Complete`                                          |
...
| Report real bugs / performance issues if needed                               | Stress degradation observation                                  | `submission/tests/3-test-summary/checkout-with-coupon/issue-reports/ISSUE-CWC-001.md`                               | `Pass`           | `Prepared for submission / optional GitHub posting` |
| Provide video demo with narration                                             | Submission video link                                           | Recording checklist exists, but no final link yet                                                                   | `Pending manual` | `Manual close-out required`                         |
...
| Video demo link                  | Main report / README                                                                                                                         | `Pending manual` | Recording checklist exists; final YouTube link must be added manually |
