# TC-FORGOT-PASSWORD-006: Step 2 - OTP field is empty
...
6. Leave the OTP input field empty.
...
- A validation error message (e.g., "Mã OTP không được để trống") appears **above** the submit button.
