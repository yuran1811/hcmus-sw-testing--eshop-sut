# TC-FORGOT-PASSWORD-010: Step 2 - OTP contains non-digit characters
...
| otp | `12345a` (Contains character 'a') |
...
6. Enter `12345a` into the OTP input field.
...
- A validation error message (e.g., "Mã OTP chỉ được chứa chữ số") appears **above** the submit button.
