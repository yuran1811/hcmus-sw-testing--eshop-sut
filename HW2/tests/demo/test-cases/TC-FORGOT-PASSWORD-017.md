# TC-FORGOT-PASSWORD-017: Step 2 - Password missing special character
...
| otp | `123456` (Baseline) |
| newPassword | `Reset1234` (Uppercase + lowercase + digits, no special character) |
| confirmNewPassword | `Reset1234` |
...
7. Enter `Reset1234` into the "Mật khẩu mới" input field.
8. Enter `Reset1234` into the "Xác nhận mật khẩu mới" input field.
9. Click the "Đặt lại mật khẩu" submit button.

## Expected result

- The form is not submitted.
- A validation error message (e.g., "Mật khẩu phải chứa ít nhất 1 ký tự đặc biệt (@, $, !, %, *, ?, &)") appears **above** the submit button.
