# TC-FORGOT-PASSWORD-018: Step 2 - Password contains invalid special character
...
| otp | `123456` (Baseline) |
| newPassword | `Reset123#` (Contains '#' which is not in the allowed special character list: @, $, !, %, *, ?, &) |
...
- A validation error message (e.g., "Mật khẩu chứa ký tự đặc biệt không hợp lệ") appears **above** the submit button.
