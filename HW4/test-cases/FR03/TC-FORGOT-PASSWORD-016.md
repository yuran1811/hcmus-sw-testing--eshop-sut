# TC-FORGOT-PASSWORD-016: Yêu cầu gửi OTP liên tục nhiều lần (Spamming)
...
| Category | Security |
| Purpose | Yêu cầu gửi OTP liên tục nhiều lần (Spamming) |
| Preconditions | SUT is running; account or reset-flow fixture is prepared for email `user_f03_16@eshop.com` when the case requires an existing user. |
| Email | user_f03_16@eshop.com |
| New password | N/A |
...
2. Enter email value: `user_f03_16@eshop.com`.
...
- Case ID in data file: `F03-TC-016`
