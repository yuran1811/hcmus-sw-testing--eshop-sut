# TC-FORGOT-PASSWORD-018: Kiểm tra nhãn trường bắt buộc * và màu sắc nút bấm
...
| Category | GUI |
| Purpose | Kiểm tra nhãn trường bắt buộc * và màu sắc nút bấm |
| Preconditions | SUT is running; account or reset-flow fixture is prepared for email `user_f03_18@eshop.com` when the case requires an existing user. |
| Email | user_f03_18@eshop.com |
| New password | N/A |
...
2. Enter email value: `user_f03_18@eshop.com`.
...
- Case ID in data file: `F03-TC-018`
