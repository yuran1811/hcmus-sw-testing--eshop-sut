# TC-FORGOT-PASSWORD-005: Đặt lại mật khẩu với mã OTP không chính xác
...
| Category | Negative |
| Purpose | Đặt lại mật khẩu với mã OTP không chính xác |
| Preconditions | SUT is running; account or reset-flow fixture is prepared for email `user_f03_05@eshop.com` when the case requires an existing user. |
| Email | user_f03_05@eshop.com |
...
2. Enter email value: `user_f03_05@eshop.com`.
3. Continue to the reset step using OTP mode: `invalid`.
...
- Case ID in data file: `F03-TC-005`
