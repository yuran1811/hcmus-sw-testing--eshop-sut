# TC-FORGOT-PASSWORD-013: Sử dụng lại OTP đã dùng thành công
...
| Category | Security |
| Purpose | Sử dụng lại OTP đã dùng thành công |
| Preconditions | SUT is running; account or reset-flow fixture is prepared for email `user_f03_13@eshop.com` when the case requires an existing user. |
| Email | user_f03_13@eshop.com |
...
2. Enter email value: `user_f03_13@eshop.com`.
3. Continue to the reset step using OTP mode: `reused`.
...
- Case ID in data file: `F03-TC-013`
