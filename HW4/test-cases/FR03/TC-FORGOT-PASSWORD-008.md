# TC-FORGOT-PASSWORD-008: Đặt lại mật khẩu thiếu chữ hoa
...
| Category | Negative |
| Purpose | Đặt lại mật khẩu thiếu chữ hoa |
| Preconditions | SUT is running; account or reset-flow fixture is prepared for email `user_f03_08@eshop.com` when the case requires an existing user. |
| Email | user_f03_08@eshop.com |
...
2. Enter email value: `user_f03_08@eshop.com`.
...
- Case ID in data file: `F03-TC-008`
