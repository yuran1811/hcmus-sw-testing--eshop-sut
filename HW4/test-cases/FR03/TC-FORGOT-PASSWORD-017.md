# TC-FORGOT-PASSWORD-017: Kiểm tra hiển thị Step Indicator và các liên kết điều hướng
...
| Category | GUI |
| Purpose | Kiểm tra hiển thị Step Indicator và các liên kết điều hướng |
| Preconditions | SUT is running; account or reset-flow fixture is prepared for email `user_f03_17@eshop.com` when the case requires an existing user. |
| Email | user_f03_17@eshop.com |
| New password | N/A |
...
2. Enter email value: `user_f03_17@eshop.com`.
...
- Case ID in data file: `F03-TC-017`
