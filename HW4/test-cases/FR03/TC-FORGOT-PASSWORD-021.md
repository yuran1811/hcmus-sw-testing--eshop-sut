# TC-FORGOT-PASSWORD-021: Kiểm tra vô hiệu hóa nút submit khi đang xử lý yêu cầu (Double Submit Prevention)
...
| Category | GUI |
| Purpose | Kiểm tra vô hiệu hóa nút submit khi đang xử lý yêu cầu (Double Submit Prevention) |
| Preconditions | SUT is running; account or reset-flow fixture is prepared for email `user_f03_21@eshop.com` when the case requires an existing user. |
| Email | user_f03_21@eshop.com |
| New password | N/A |
...
2. Enter email value: `user_f03_21@eshop.com`.
...
- Case ID in data file: `F03-TC-021`
