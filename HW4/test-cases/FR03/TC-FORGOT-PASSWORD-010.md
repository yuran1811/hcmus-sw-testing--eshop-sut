# TC-FORGOT-PASSWORD-010: Đặt lại mật khẩu thiếu chữ số
...
| Category | Negative |
| Purpose | Đặt lại mật khẩu thiếu chữ số |
| Preconditions | SUT is running; account or reset-flow fixture is prepared for email `user_f03_10@eshop.com` when the case requires an existing user. |
| Email | user_f03_10@eshop.com |
...
2. Enter email value: `user_f03_10@eshop.com`.
3. Continue to the reset step using OTP mode: `valid`.
4. Enter new password: `New Pass`.
5. Enter confirm password: `New Pass`.
...
- Case ID in data file: `F03-TC-010`
