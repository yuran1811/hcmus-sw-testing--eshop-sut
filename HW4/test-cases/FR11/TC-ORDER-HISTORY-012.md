# TC-ORDER-HISTORY-012: Verify cancellation of confirmed order triggers alert and updates status
...
| Purpose | Verify cancellation of confirmed order triggers alert and updates status |
...
3. Use/verify an order fixture with amount `700000`.
...
- Case ID in data file: `F11-TC-012`
