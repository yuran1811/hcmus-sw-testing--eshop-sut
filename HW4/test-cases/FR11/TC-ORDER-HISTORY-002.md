# TC-ORDER-HISTORY-002: Verify logged-in user can only see their own orders and not others
...
| Purpose | Verify logged-in user can only see their own orders and not others |
...
- Case ID in data file: `F11-TC-002`
