# TC-ORDER-HISTORY-014: Verify user cannot cancel delivered orders (button hidden)
...
| Purpose | Verify user cannot cancel delivered orders (button hidden) |
...
- Case ID in data file: `F11-TC-014`
