# TC-ORDER-HISTORY-015: Verify user cannot cancel canceled orders (button hidden)
...
| Purpose | Verify user cannot cancel canceled orders (button hidden) |
...
- Case ID in data file: `F11-TC-015`
