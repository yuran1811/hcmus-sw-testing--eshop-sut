# TC-ORDER-HISTORY-013: Verify user cannot cancel shipping orders (button hidden or disabled)
...
| Purpose | Verify user cannot cancel shipping orders (button hidden or disabled) |
...
3. Use/verify an order fixture with amount `800000`.
...
- Case ID in data file: `F11-TC-013`
