# TC-USER-MANAGEMENT-006: Verify standard user call to DELETE /api/admin/users/:id returns 403
...
| Purpose | Verify standard user call to DELETE /api/admin/users/:id returns 403 |
...
- Case ID in data file: `F19-TC-006`
