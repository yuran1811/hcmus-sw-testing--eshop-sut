# TC-USER-MANAGEMENT-011: Verify admin is prevented from self-deleting on the user management UI
...
| Category | Functional |
| Purpose | Verify admin is prevented from self-deleting on the user management UI |
...
- Case ID in data file: `F19-TC-011`
