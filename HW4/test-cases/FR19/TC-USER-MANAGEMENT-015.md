# TC-USER-MANAGEMENT-015: Verify tab key navigation order is top-to-bottom, left-to-right
...
| Category | Usability |
| Purpose | Verify tab key navigation order is top-to-bottom, left-to-right |
...
- Case ID in data file: `F19-TC-015`
