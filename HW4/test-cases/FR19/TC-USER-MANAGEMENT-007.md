# TC-USER-MANAGEMENT-007: Verify user list table header columns and rows are displayed correctly
...
| Category | User List |
| Purpose | Verify user list table header columns and rows are displayed correctly |
...
- Case ID in data file: `F19-TC-007`
