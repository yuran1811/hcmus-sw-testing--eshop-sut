# TC-USER-MANAGEMENT-016: Verify user name/phone containing XSS scripts is escaped safely on the UI
...
| Category | Security |
| Purpose | Verify user name/phone containing XSS scripts is escaped safely on the UI |
| Preconditions | SUT is running; admin fixture is available; test user credential `user_f19_xss@eshop.com` is prepared when required. |
...
2. Use account/email: `user_f19_xss@eshop.com`.
...
- Case ID in data file: `F19-TC-016`
