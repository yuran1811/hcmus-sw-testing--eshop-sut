# TC-USER-MANAGEMENT-009: Verify Vietnamese language consistency for user list page elements
...
| Purpose | Verify Vietnamese language consistency for user list page elements |
...
- Case ID in data file: `F19-TC-009`
