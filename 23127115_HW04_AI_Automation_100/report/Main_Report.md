...
Quá trình chuyển đổi test case thành Playwright script được thực hiện theo hướng có kiểm soát: test case thiết kế là nguồn chính, AI chỉ hỗ trợ tạo nháp script, còn tester rà soát lại mapping, dữ liệu, assertion và kết quả mong đợi.
