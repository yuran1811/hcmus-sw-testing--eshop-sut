...
- [Ảnh minh họa GitHub Issues](./images)
...
| File log nộp kèm                                                            | [git_commit_logs.txt](./git_commit_logs.txt) |
...
```text
23127115_HW04_AI_Automation_100.zip
```

Khi đóng gói, cần export các file Markdown bắt buộc sang PDF tương ứng, đặc biệt `Main_Report.md`, `README.md`, `Bug_Report.md`, `AI_Audit_Report.md` và `AI_Critique.md`.

## 15. Checklist cuối trước khi nộp

| Checklist                                                   | Trạng thái                 |
| ----------------------------------------------------------- | -------------------------- |
| Có 3 tính năng web thuộc nhóm A, B, C                       | Đạt                        |
| Mỗi tính năng có ít nhất 12 test case được tự động hóa      | Đạt                        |
| Có file dữ liệu JSON riêng cho data-driven testing          | Đạt                        |
| Có ít nhất 3 kiểu assertion                                 | Đạt                        |
| Chạy trên Chromium, Firefox, WebKit                         | Đạt                        |
| Có HTML report hiển thị `Run by: 23127115` và timestamp ISO | Đạt                        |
| Có báo cáo bug Markdown và GitHub Issues kèm evidence       | Đạt                        |
| Có AI Audit Report                                          | Đạt                        |
| Có AI Critique 200-300 từ                                   | Đạt                        |
| Có Agent Skills nộp kèm                                     | Đạt                        |
| Có video demo link                                          | Đạt                        |
| Có tối thiểu 8 commit chạm file test script                 | Đạt                        |
| Có file git commit log nộp kèm                              | Đạt                        |
| Cần export Markdown sang PDF trước khi nộp Moodle           | Cần thực hiện khi đóng gói |
