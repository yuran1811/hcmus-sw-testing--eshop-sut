...
5. Identify the feature's **Module** name (e.g. `LOGIN`, `REGISTER`) and assign a **Requirement ID** following the project convention `FR-[MODULE]-[NN]` (e.g. `FR-LOGIN-01`).
