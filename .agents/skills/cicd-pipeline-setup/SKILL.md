...
1. Commit + push with a message like: `test: intentional failing case to demonstrate CI failure detection`.
2. Screenshot the pipeline showing red/failing, copy the run link.
