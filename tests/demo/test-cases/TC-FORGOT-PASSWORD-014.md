# TC-FORGOT-PASSWORD-014: Step 2 - Password missing uppercase letter
...
| otp | `123456` (Baseline) |
| newPassword | `reset123!` (All lowercase + digits + special) |
...
- A validation error message (e.g., "Mật khẩu phải chứa ít nhất 1 chữ hoa") appears **above** the submit button.
