# TC-FORGOT-PASSWORD-016: Step 2 - Password missing digit
...
| otp | `123456` (Baseline) |
| newPassword | `Resetxyz!` (Uppercase + lowercase + special, no digits) |
| confirmNewPassword | `Resetxyz!` |
...
7. Enter `Resetxyz!` into the "Mật khẩu mới" input field.
8. Enter `Resetxyz!` into the "Xác nhận mật khẩu mới" input field.
9. Click the "Đặt lại mật khẩu" submit button.

## Expected result

- The form is not submitted.
- A validation error message (e.g., "Mật khẩu phải chứa ít nhất 1 chữ số") appears **above** the submit button.
