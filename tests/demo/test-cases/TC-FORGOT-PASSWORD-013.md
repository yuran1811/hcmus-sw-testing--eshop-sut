# TC-FORGOT-PASSWORD-013: Step 2 - Password length is 7 characters (Too short)
...
| otp | `123456` (Baseline) |
| newPassword | `Res123!` (Length 7) |
| confirmNewPassword | `Res123!` (Length 7, matching newPassword) |
...
7. Enter `Res123!` into the "Mật khẩu mới" input field.
8. Enter `Res123!` into the "Xác nhận mật khẩu mới" input field.
9. Click the "Đặt lại mật khẩu" submit button.

## Expected result

- The form is not submitted.
- A validation error message (e.g., "Mật khẩu phải chứa tối thiểu 8 ký tự") appears **above** the submit button.
