...
- Name: coupon.spec.js >> Coupon (FR-09) E2E Tests >> TC-COUPON-013: SAVE10, total = 300,001 (IN, vừa trên ngưỡng SAVE10) -> được chấp nhận
- Location: coupon.spec.js:213:3
...
Expected substring: "Tiết kiệm: 30.000 ₫"
Received string:    "✅ Áp dụng thành công! Giảm 10%Tiết kiệm: -2,700,009 ₫Thành tiền: 3,000,010 ₫"
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('div.text-green-700')
    10 × locator resolved to <div class="mt-2 text-green-700 text-sm space-y-1">…</div>
       - unexpected value "✅ Áp dụng thành công! Giảm 10%Tiết kiệm: -2,700,009 ₫Thành tiền: 3,000,010 ₫"
