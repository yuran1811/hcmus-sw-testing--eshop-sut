...
- Name: product-detail.spec.js >> Product Detail (FR-06) E2E Tests >> TC-PRODUCT-DETAIL-012: Chưa đăng nhập, bấm "Thêm vào giỏ hàng" -> bị từ chối (yêu cầu đăng nhập, API trả về 401)
- Location: product-detail.spec.js:214:3
...
Call log:
  - Expect "toHaveURL" with timeout 1000ms
    12 × unexpected value "http://localhost:5173/product/1"
