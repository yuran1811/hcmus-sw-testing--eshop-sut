...
- Name: coupon.spec.js >> Coupon (FR-09) E2E Tests >> TC-COUPON-008: Chưa đăng nhập hệ thống -> trả về lỗi xác thực
- Location: coupon.spec.js:149:3
...
Call log:
  ...
  - waiting for locator('div.text-green-700')
    12 × locator resolved to <div class="mt-2 text-green-700 text-sm space-y-1">…</div>
