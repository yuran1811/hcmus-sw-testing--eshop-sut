...
- Name: coupon.spec.js >> Coupon (FR-09) E2E Tests >> TC-COUPON-015: BIGBUY, total = 500,001 (IN, vừa trên ngưỡng BIGBUY) -> được chấp nhận
- Location: coupon.spec.js:236:3
...
Locator: locator('text=Áp dụng thành công! Giảm 50.000 ₫')
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('text=Áp dụng thành công! Giảm 50.000 ₫')
...
- main:
    ...
    - button "Áp dụng"
    - paragraph: ✅ Áp dụng thành công! Giảm 50,000 ₫
    - paragraph:
        - text: 'Tiết kiệm:'
        - strong: 50,000 ₫
    - paragraph:
