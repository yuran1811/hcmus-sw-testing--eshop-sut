...
- Name: coupon.spec.js >> Coupon (FR-09) E2E Tests >> TC-COUPON-012: SAVE10, total = 300,000 (ON, đúng ngưỡng min = 300,000) -> được chấp nhận
- Location: coupon.spec.js:203:3
...
Locator: locator('text=Áp dụng thành công! Giảm 10%')
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('text=Áp dụng thành công! Giảm 10%')
