...
- Name: product-detail.spec.js >> Product Detail (FR-06) E2E Tests >> TC-PRODUCT-DETAIL-004: Quantity hợp lệ (2) -> thêm vào giỏ thành công; hiển thị toast notification và/hoặc badge giỏ hàng cập nhật
- Location: product-detail.spec.js:78:3
...
Locator: locator('button:has-text("Đã thêm")')
Expected: visible
Timeout: 1000ms
...
Call log:
  ...
  - waiting for locator('button:has-text("Đã thêm")')
