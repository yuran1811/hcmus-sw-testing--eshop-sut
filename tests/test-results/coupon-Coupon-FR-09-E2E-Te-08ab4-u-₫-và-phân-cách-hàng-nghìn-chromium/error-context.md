...
- Name: coupon.spec.js >> Coupon (FR-09) E2E Tests >> TC-COUPON-016: Nhất quán đơn vị tiền: hiển thị số tiền giảm và tổng tiền có ký hiệu ₫ và phân cách hàng nghìn
- Location: coupon.spec.js:249:3
...
Received string:    "✅ Áp dụng thành công! Giảm 100,000 ₫Tiết kiệm: 100,000 ₫Thành tiền: 300,000 ₫"
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('div.text-green-700')
    10 × locator resolved to <div class="mt-2 text-green-700 text-sm space-y-1">…</div>
       - unexpected value "✅ Áp dụng thành công! Giảm 100,000 ₫Tiết kiệm: 100,000 ₫Thành tiền: 300,000 ₫"
