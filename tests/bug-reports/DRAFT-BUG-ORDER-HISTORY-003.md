...
## Evidence
- Code file: [Profile.jsx](file:///d:/Project/Testing/hcmus-sw-testing--eshop-sut/frontend-web/src/pages/Profile.jsx) (không có bộ lọc trạng thái nào được định nghĩa).
