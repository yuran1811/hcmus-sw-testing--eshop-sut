# [BUG][Order History] Lỗ hổng bảo mật nghiêm trọng IDOR tại API lấy chi tiết đơn hàng (GET /api/orders/:id)
...
- API Test execution output:
  ...
  ```
- Code file: [server.js:L344-349](file:///d:/Project/Testing/hcmus-sw-testing--eshop-sut/backend/server.js#L344-L349)
