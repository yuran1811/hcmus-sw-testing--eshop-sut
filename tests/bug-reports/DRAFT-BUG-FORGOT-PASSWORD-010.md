...
## Evidence
- Code file: [ForgotPassword.jsx](file:///d:/Project/Testing/hcmus-sw-testing--eshop-sut/frontend-web/src/pages/ForgotPassword.jsx) (không có nút điều hướng ngược ở `step === 1`).
