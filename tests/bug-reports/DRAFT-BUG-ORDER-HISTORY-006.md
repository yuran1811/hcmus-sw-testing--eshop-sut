...
## Evidence
- Code file: [Profile.jsx](file:///d:/Project/Testing/hcmus-sw-testing--eshop-sut/frontend-web/src/pages/Profile.jsx) (chỉ sử dụng thẻ `<h2>` tại dòng 113 và 167, không có thẻ `<h1>`).
- Giao diện header trong [App.jsx](file:///d:/Project/Testing/hcmus-sw-testing--eshop-sut/frontend-web/src/App.jsx) cũng không chứa thẻ `<h1>`.
