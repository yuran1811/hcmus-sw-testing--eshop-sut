# TC-HOTEL-011: Tính tiền phòng với Số người bằng 5 (Biên không hợp lệ trên)
...
3. Nhập Số lượng người (NumPeople) là 5
4. Nhập Tiền dịch vụ (ServiceFee) là 500,000
5. Bấm nút Tính tiền phòng

## Expected result

Hệ thống từ chối tính toán và hiển thị thông báo lỗi 'Số lượng người tối đa cho phép là 4 người'.
