...
- Người tham gia: P04 *(thông tin cá nhân giữ ở `recruitment-tracker.md`, không ghi lại ở đây)*
...
> Nhắc lại ranh giới khi chấm: thành công = *áp được mã và tới màn hình xác nhận*, **không** phải
> *số tiền giảm đúng*. Nếu số tiền hiển thị sai, ghi vào Timeline như một quan sát — đừng vì thế
...
- [ ] Người tham gia có mở trang **Giỏ hàng** để tìm ô nhập mã trước khi tới Checkout không? *(mục tiêu 2)*
- [ ] Có dừng lại ≥ 5 giây ở màn hình Giỏ hàng hoặc Checkout không? *(mục tiêu 2)*
- [ ] Trước khi bấm "Xác Nhận Thanh Toán", có nhìn/đọc lại số tiền cuối cùng không? *(mục tiêu 3)*
- [ ] Có nhận ra ô "Tổng tiền thanh toán" sửa được không? Nếu có, phản ứng ra sao? *(mục tiêu 3)*
...
| Clarity | ↳ *(câu đuôi — chỉ hỏi nếu câu 1 bị trả lời cụt)* Trước khi tìm thấy ô đó, bạn có nhìn qua chỗ nào khác không? | |
