...
- Name: category-crud.spec.ts >> FR-14 Category CRUD — Equivalence Partitioning >> TC-CATEGORY-019-2: DELETE với ID sai cú pháp (1.5) — không xóa, không lỗi máy chủ (EC17)
