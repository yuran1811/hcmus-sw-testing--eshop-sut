...
- Name: category-crud.spec.ts >> FR-14 Category CRUD — Equivalence Partitioning >> TC-CATEGORY-004: Xem danh sách danh mục thành công — GET /api/categories
- Location: tests\category-crud.spec.ts:110:7
