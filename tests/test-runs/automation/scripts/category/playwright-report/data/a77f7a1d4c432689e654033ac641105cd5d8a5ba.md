...
- Name: category-auth.spec.ts >> FR-14 Category Authorization — Equivalence Partitioning >> TC-CATEGORY-011: Xóa danh mục thất bại khi dùng token user thường (EC5)
- Location: tests\category-auth.spec.ts:106:7
