...
- Name: category-crud.spec.ts >> FR-14 Category CRUD — Equivalence Partitioning >> TC-CATEGORY-012: Thêm danh mục thất bại khi body thiếu thuộc tính name (EC2)
- Location: tests\category-crud.spec.ts:219:7
