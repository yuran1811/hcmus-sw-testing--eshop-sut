...
- Name: checkout-api.spec.ts >> FR-08 Checkout — API Tests (Equivalence Partitioning) >> TC-CHECKOUT-014: Backend không dùng items/giá giả mạo từ client payload
- Location: tests\checkout-api.spec.ts:359:7
