...
- Name: checkout-bva.spec.ts >> FR-08 Checkout — BVA Tests (Boundary Value Analysis) >> TC-CHECKOUT-BVA-002: total_amount thấp hơn giá trị hệ thống tính
- Location: tests\checkout-bva.spec.ts:103:7
