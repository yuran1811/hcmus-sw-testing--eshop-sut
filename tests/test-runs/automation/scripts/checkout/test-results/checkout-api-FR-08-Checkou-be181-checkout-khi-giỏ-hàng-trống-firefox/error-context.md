...
- Name: checkout-api.spec.ts >> FR-08 Checkout — API Tests (Equivalence Partitioning) >> TC-CHECKOUT-003: Từ chối checkout khi giỏ hàng trống
- Location: tests\checkout-api.spec.ts:134:7
