...
- Name: checkout-api.spec.ts >> FR-08 Checkout — API Tests (Equivalence Partitioning) >> TC-CHECKOUT-002: Từ chối checkout khi dùng token JWT không hợp lệ
- Location: tests\checkout-api.spec.ts:110:7
