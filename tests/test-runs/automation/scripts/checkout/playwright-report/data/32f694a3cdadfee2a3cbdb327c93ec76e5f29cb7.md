...
- Name: checkout-api.spec.ts >> FR-08 Checkout — API Tests (Equivalence Partitioning) >> TC-CHECKOUT-010C: shipping_address là Object (type mismatch)
- Location: tests\checkout-api.spec.ts:305:9
