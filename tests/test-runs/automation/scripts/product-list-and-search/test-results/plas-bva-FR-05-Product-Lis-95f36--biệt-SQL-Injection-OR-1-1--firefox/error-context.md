...
- Name: plas-bva.spec.ts >> FR-05 Product List & Search — BVA (Boundary Value Analysis) >> TC-PLAS-BVA-004: Tìm kiếm bằng ký tự đặc biệt SQL Injection (' OR '1'='1)
- Location: tests\plas-bva.spec.ts:87:7
