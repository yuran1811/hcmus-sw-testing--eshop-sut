...
- Name: plas-ep.spec.ts >> FR-05 Product List & Search — Equivalence Partitioning >> TC-PLAS-002: Tìm kiếm sản phẩm theo tên chính xác hợp lệ
- Location: tests\plas-ep.spec.ts:76:7
  ...
  - main [ref=e10]:
    - generic [ref=e11]:
      - generic [ref=e12]:
        ...
        - generic [ref=e14]:
          - textbox "Tìm kiếm..." [ref=e15]: MacBook Pro M3
          - button "Tìm" [active] [ref=e16] [cursor=pointer]
      - generic [ref=e17]: "Kết quả tìm kiếm cho: MacBook Pro M3"
      - generic [ref=e19]:
