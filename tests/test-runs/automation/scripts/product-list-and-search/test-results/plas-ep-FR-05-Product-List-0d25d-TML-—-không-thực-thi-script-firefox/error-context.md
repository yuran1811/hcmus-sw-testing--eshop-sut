...
- Name: plas-ep.spec.ts >> FR-05 Product List & Search — Equivalence Partitioning >> TC-PLAS-005: Tìm kiếm với mã độc XSS / script HTML — không thực thi script
- Location: tests\plas-ep.spec.ts:135:7
...
SQLITE_ERROR: near \"XSS\": syntax error
