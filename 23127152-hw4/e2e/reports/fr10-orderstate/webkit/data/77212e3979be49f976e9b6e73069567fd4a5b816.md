...
- Name: fr10-orderstate/fr10-orderstate.spec.ts >> FR-10 — Order State Machine >> FR10-TC10 — Chặn chuyển trạng thái canceled sang delivered (final-state boundary, BUG-06 đã biết)
